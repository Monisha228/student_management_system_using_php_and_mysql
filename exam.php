...
<?php
	if(isset($_POST["submit"]))
	{
		...
		$sq="insert into exam(ENAME,SESS,EYEAR,DEPARTMENT,EDEGREE,SUBJECTS,EDATE) values('$ename','$ses','$yr','$dep','$de','$sub','$edate')";
		if($db->query($sq))
		{
	...
	?>
<div class="totals">
	<div style="height:460px;"class="exam-form">
		<form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>"> 
		
<label>Select Exam</label><br>
    <select name="ename" class="input7" required>
    	<option value="">Select</option>
    	<option value="I internal">I internal</option>
    	<option value="II">II internal</option>
		...
		<label>Session</label>
<select name="ses" class="input7" required>
    	<option value="">Select</option>
    	<option value="Morning">FN</option>
    	<option value="Afternoon">AN</option>
    	</select><br>
<label>Select Year</label><br>
		<select name="yr" class="input7" required>
			<?php
    ...
    <select name="dep" class="input7" required>
    	<?php
    ...
    <select name="de" class="input7" required>
    	<?php
    ...
    <select name="sub" class="input7" required>
    	<?php
    	$sw="select * from sub";
    	$re=$db->query($sw);
    	if($re->num_rows>0)
...
<select name="ye" class="input8">
    	...
    	<option value="2034">2034</option>
		  ...
		  <button type="submit" class="btn2" name="submit">Add Exam</button>
		</form>
	</div>
</div>
	<footer>
