...
<h3 class="i-name">Student</h3>
<button class="btn0"name="sub"><a href="view-student.php">View student</a></button>
...
<?php
						if(isset($_POST["submit"]))
						{
							...
							{
								$sq="insert into student(RNO,NAME,FNAME,DOB,GEN,PHO,MAIL,SDEPT,SYEAR,SIMG,AID,ADDR,SPASS) values('{$_POST["rno"]}','{$_POST["name"]}','{$_POST["fname"]}','{$edate}','{$_POST["gen"]}','{$_POST["pho"]}','{$_POST["email"]}','{$_POST["dpt"]}','{$_POST["yr"]}','{$target_file}','{$_SESSION["AID"]}','{$_POST["addr"]}','student')";
...
<form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER["PHP_SELF"];?>">
					...
					<input type="text" class="input3" required name="name">
					<label> Father Name</label>
					<input type="text" class="input3" required name="fname"><br>
				...
				<label> Parent's Mail Id</label>
					<input type="email"required  class="input3" name="email">
			...
			<label>  Address</label>
					<textarea rows="2" required name="addr"></textarea><br>
